...
export const ParallaxImage = ({
  ...
  useEffect(() => {
    ...
    function onMouseMove(event: MouseEvent) {
      ...
      const xPercent = (event.clientX / innerWidth - 0.5) * 2; //Will give a range between -1 and 1
      const yPercent = (event.clientY / innerHeight - 0.5) * 2; //Will give a range between -1 and 1
