...
import { ColorField, isFilled } from "@prismicio/client";
...
const Controls = ({ wheels, decks, metals, className }: Props) => {
  ...
  }, [router, selectedWheel, selectedDeck, selectedBolt, selectedTruck]);
